...
<html lang="zh-cn">
  ...
  <body>
	<img src="image/4.jpg" width="100%" height="200px"  alt="背景图片">
    <h2 align="right" > 欢迎你，<?php echo $tname; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h2>
	<div  id="afbox6">
   <h3 align="center" > 介绍</h3>
   <form name="form1" enctype="multipart/form-data" method="post" action="http://xfycn.com.cn/php/teacher/saveModifyInformation.php">
